...
<div id='_0fwp'><div id='_0fw'>
	<script type="text/javascript">
		_0fw.parentNode.url=['actionform.jsp?action=base.LoginForm'].join('');
		compList.requests.unshift([_0fw.parentNode.url,['_action=initor','&_fw=_0fw'].join('')]);
	</script>
</div></div>
<script type="text/javascript">
	compList.getLazyRequest();
	window.Validator.InsertWarn(null, '测试体验账号：商家,南宁古城，用户名,admin，密码,123，登录网址,<a href="http://www.haosale.top/l" target="_0">www.haosale.top</a>');
</script>
