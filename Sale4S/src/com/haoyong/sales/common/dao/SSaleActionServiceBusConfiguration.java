...
public class SSaleActionServiceBusConfiguration extends ActionServiceBusConfiguration {
	...
	protected void analyzeService() throws InstantiationException, IllegalAccessException {
		...
		// Action之间的关系逻辑。
		// 这段分析过程通常只需执行一遍。
		String rootPackage = SSaleUtil.getProperties().getString("BusConfigurationRoot");
